...
Blockly.Msg.LISTS_FOR_ALL2_TOOLTIP = 'for_all2 p al bl checks if all elements of the 2 list satisfy the predicate p. Raise Invalid_argument if the two lists are determined to have different lengths.'
