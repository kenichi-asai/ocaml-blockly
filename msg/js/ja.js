...
Blockly.Msg["ADD_IN"] = "in を追加";
Blockly.Msg["ADD_REC"] = "rec を追加";
Blockly.Msg["ANDMAP_TOOLTIP"] = "リスト中の要素が全て条件を満たすかを調べる";
Blockly.Msg["BIGBANG_TOOLTIP"] = "世界を創る";
Blockly.Msg["BOOL_OF_STRING"] = "文字列を真偽値に変換して返します。";
Blockly.Msg["CANNOT_DELETE_VARIABLE_PROCEDURE"] = "変数 '%1' は関数 '%2' の定義の一部であるため、削除できません";
Blockly.Msg["CHANGE_VALUE_TITLE"] = "値を変える：";
Blockly.Msg["CIRCLE_OUTLINE_TOOLTIP"] = "受け取った半径、色の円の輪郭を描く";
Blockly.Msg["CIRCLE_TOOLTIP"] = "受け取った半径、色の円を作る";
...
Blockly.Msg["DECREASE_HOLE"] = "関数の穴を削除";
Blockly.Msg["DEFINE_LET_IN_TOOLTIP"] = "局所変数の定義";
Blockly.Msg["DEFINE_LET_REC_TOOLTIP"] = "再帰関数の定義";
Blockly.Msg["DEFINE_RECORD_TOOLTIP"] = "レコードを宣言";
Blockly.Msg["DEFINE_VARIABLE_TOOLTIP"] = "変数の定義";
...
Blockly.Msg["EMPTY_SCENE_TOOLTIP"] = "無地の背景を作る";
...
Blockly.Msg["IMAGE_HEIGHT_TOOLTIP"] = "画像の縦幅を返す";
Blockly.Msg["IMAGE_WIDTH_TOOLTIP"] = "画像の横幅を返す";
Blockly.Msg["INCREASE_HOLE"] = "関数の穴を追加";
...
Blockly.Msg["LINE_TOOLTIP"] = "(0, 0) から (x, y) を繋げた線を作る。";
Blockly.Msg["LISTS_ASSOC_TOOLTIP"] = "assoc a l はペアのリスト l でキー a に対応する値を返す";
Blockly.Msg["LISTS_CONCAT_TOOLTIP"] = "リストのリストを結合します。引数の要素を全て結合して返します。";
...
Blockly.Msg["LISTS_FILTER_TOOLTIP"] = "filter p l は述語 p を満たす l の全ての要素を返す。";
Blockly.Msg["LISTS_FOR_ALL2_TOOLTIP"] = "forall2 p al bl は ２つのリストの全ての要素が述語 p を満たすかチェック。2 つのリストの長さが異なる場合、例外 Invalid_argument を発生する。";
...
Blockly.Msg["LISTS_MAP2_TOOLTIP"] = "map2 f al bl は al bl の各要素に f を施したリストを返す。2つのリストの長さが異なる場合、例外 Invalid_argument を発生する。";
Blockly.Msg["LISTS_MAP_TOOLTIP"] = "map f l は l の各要素に f を施したリストを返す。";
...
Blockly.Msg["LISTS_SPLIT_TOOLTIP"] = "split l はペアのリスト l をリストのペアに変換する";
...
Blockly.Msg["MAKE_COLOR2_TOOLTIP"] = "RGB と透過率 A から色を作る。";
Blockly.Msg["MAKE_COLOR_TOOLTIP"] = "RGB から色を作る。";
...
Blockly.Msg["MATH_ARITHMETIC_TOOLTIP_MOD"] = "整数の割り算の余りを返します。";
...
Blockly.Msg["MATH_FLOAT_OF_INT"] = "整数を実数に変換します。";
Blockly.Msg["MATH_INT_OF_FLOAT"] = "実数を整数に変換します。";
...
Blockly.Msg["MATH_SINGLE_TOOLTIP_ABS"] = "整数の絶対値を返します。";
...
Blockly.Msg["MATH_SINGLE_TOOLTIP_ROOT"] = "実数の平方根を返します。";
Blockly.Msg["MATH_SPECIALFLOAT_INFINITY"] = "正の最大限を表します。";
Blockly.Msg["MATH_SPECIALFLOAT_NAN"] = "非数(実数ではない値)を表します。";
Blockly.Msg["MATH_SPECIALFLOAT_NEGINFINITY"] = "負の最大限を表します。";
Blockly.Msg["MATH_SPECIALINT_MAX"] = "最大の整数を表します。";
Blockly.Msg["MATH_SPECIALINT_MIN"] = "最小の整数を表します。";
Blockly.Msg["MATH_STRING_OF_FLOAT"] = "実数を文字列に変換します。";
...
Blockly.Msg["ORMAP_TOOLTIP"] = "リストの中に条件を満たす要素があるかを調べる";
Blockly.Msg["PAIR_GET_FIRST_TOOLTIP"] = "ペアの一つ目を取得する";
Blockly.Msg["PAIR_GET_SECOND_TOOLTIP"] = "ペアの二つ目を取得する";
Blockly.Msg["PLACE_IMAGES_TOOLTIP"] = "元の画像の上に複数の新たな画像を指定した位置に重ねる";
Blockly.Msg["PLACE_IMAGE_TOOLTIP"] = "元の画像の上に新たな画像を指定した位置に重ねる";
Blockly.Msg["POLYGON_OUTLINE_TOOLTIP"] = "多角形の外郭を作る。";
Blockly.Msg["POLYGON_TOOLTIP"] = "多角形を作る";
...
Blockly.Msg["READ_IMAGE_TOOLTIP"] = "画像ファイルを指定した大きさで読み込む";
Blockly.Msg["RECTANGLE_OUTLINE_TOOLTIP"] = "受け取った長さ、色の長方形の輪郭を描く";
Blockly.Msg["RECTANGLE_TOOLTIP"] = "受け取った長さ、色の長方形を作る";
Blockly.Msg["REDO"] = "やり直す";
Blockly.Msg["REMOVE_COMMENT"] = "コメントを削除";
Blockly.Msg["REMOVE_IN"] = "in を削除";
Blockly.Msg["REMOVE_REC"] = "rec を削除";
Blockly.Msg["RENAME_VARIABLE"] = "変数の名前を変える…";
Blockly.Msg["RENAME_VARIABLE_TITLE"] = "選択した%1の変数すべての名前を変える：";
Blockly.Msg["STRING_CONCAT"] = "文字列を結合します。";
Blockly.Msg["STRING_OF_BOOL"] = "真偽値を文字列で表現して返します。";
Blockly.Msg["STRING_OF_INT"] = "整数を文字列に変換します。";
Blockly.Msg["SUM_TOOLTIP"] = "整数のリストの合計を求める";
...
Blockly.Msg["TEXT_TOOLTIP"] = "色付きの文字列を作る";
