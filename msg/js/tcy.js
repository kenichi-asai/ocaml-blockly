...
Blockly.Msg["ADD_IN"] = "Add in";  // untranslated
Blockly.Msg["ADD_REC"] = "Add rec";  // untranslated
Blockly.Msg["ANDMAP_TOOLTIP"] = "Check if all the elements of the list satisfy the predicate.";  // untranslated
Blockly.Msg["BIGBANG_TOOLTIP"] = "Create World.";  // untranslated
Blockly.Msg["BOOL_OF_STRING"] = "Convert string to bool";  // untranslated
Blockly.Msg["CANNOT_DELETE_VARIABLE_PROCEDURE"] = "Can't delete the variable '%1' because it's part of the definition of the function '%2'";  // untranslated
Blockly.Msg["CHANGE_VALUE_TITLE"] = "ಮೌಲ್ಯೊನು ಬದಲ್ ಮಲ್ಪು";
Blockly.Msg["CIRCLE_OUTLINE_TOOLTIP"] = "Outline a circle of specified radius and color.";  // untranslated
Blockly.Msg["CIRCLE_TOOLTIP"] = "Make a circle of specified radius and color.";  // untranslated
...
Blockly.Msg["DECREASE_HOLE"] = "Decrease hole";  // untranslated
Blockly.Msg["DEFINE_LET_IN_TOOLTIP"] = "Define a function";  // untranslated
Blockly.Msg["DEFINE_LET_REC_TOOLTIP"] = "Define a recursive function";  // untranslated
Blockly.Msg["DEFINE_RECORD_TOOLTIP"] = "Declare a record type";  // untranslated
Blockly.Msg["DEFINE_VARIABLE_TOOLTIP"] = "Define a variable";  // untranslated
...
Blockly.Msg["EMPTY_SCENE_TOOLTIP"] = "Create an empty scene.";  // untranslated
...
Blockly.Msg["IMAGE_HEIGHT_TOOLTIP"] = "Return the height of an image";  // untranslated
Blockly.Msg["IMAGE_WIDTH_TOOLTIP"] = "Return the width of an image";  // untranslated
Blockly.Msg["INCREASE_HOLE"] = "Increase hole";  // untranslated
Blockly.Msg["INLINE_INPUTS"] = "ಉಳಸಾಲ್‍ದ ಉಳಪರಿಪು";
Blockly.Msg["INT_OF_STRING_TOOLTIP"] = "Convert string to int";  // untranslated
...
Blockly.Msg["LINE_TOOLTIP"] = "Make a line.";  // untranslated
Blockly.Msg["LISTS_ASSOC_TOOLTIP"] = "assoc a l returns the value associated with key a in the list of pairs l.";  // untranslated
Blockly.Msg["LISTS_CONCAT_TOOLTIP"] = "Joins a list of lists. Combines and returns all the elements of the argument.";  // untranslated
...
Blockly.Msg["LISTS_FILTER_TOOLTIP"] = "filter p l returns all the elements of the list l that satisfy the predicate p.";  // untranslated
Blockly.Msg["LISTS_FOR_ALL2_TOOLTIP"] = "for_all2 p al bl checks if all elements of the two lists satisfy the predicate p. Raise Invalid_argument if the two lists have different lengths.";  // untranslated
...
Blockly.Msg["LISTS_MAP2_TOOLTIP"] = "map f al bl applies f to each element of al bl and returns the resulting list. If the two lists differ in length, raise the exception Invalid_argument.";  // untranslated
Blockly.Msg["LISTS_MAP_TOOLTIP"] = "map f l applies f to each element of l and returns the resulting list.";  // untranslated
...
Blockly.Msg["LISTS_SPLIT_TOOLTIP"] = "Converts a list of pairs into a pair of lists.";  // untranslated
...
Blockly.Msg["LIST_PARTITION_TOOLTIP"] = "partition p l returns a pair of lists (l1, l2), where l1 is the list of all the elements of l that satisfy the predicate p, and l2 is the list of all the elements of l that do not satisfy p.";  // untranslated
...
Blockly.Msg["MAKE_COLOR2_TOOLTIP"] = "Make a color from RGB and transmittance A.";  // untranslated
Blockly.Msg["MAKE_COLOR_TOOLTIP"] = "Make a color from RGB.";  // untranslated
...
Blockly.Msg["MATH_ARITHMETIC_TOOLTIP_MOD"] = "Return the remainder of the two numbers.";  // untranslated
...
Blockly.Msg["MATH_FLOAT_OF_INT"] = "Convert integer to float";  // untranslated
Blockly.Msg["MATH_INT_OF_FLOAT"] = "Convert float to integer";  // untranslated
Blockly.Msg["MATH_INT_OF_STRING"] = "Convert a float to an integer.";  // untranslated
...
Blockly.Msg["MATH_SPECIALFLOAT_INFINITY"] = "Positive infinity of float type.";  // untranslated
Blockly.Msg["MATH_SPECIALFLOAT_NAN"] = "Not a number.";  // untranslated
Blockly.Msg["MATH_SPECIALFLOAT_NEGINFINITY"] = "Negative infinity of float type.";  // untranslated
Blockly.Msg["MATH_SPECIALINT_MAX"] = "Maximum value of integer type.";  // untranslated
Blockly.Msg["MATH_SPECIALINT_MIN"] = "Minimum value of integer type.";  // untranslated
Blockly.Msg["MATH_STRING_OF_FLOAT"] = "Convert float to string";  // untranslated
...
Blockly.Msg["OPTION_NONE_TOOLTIP"] = "constructor that represents no value.";  // untranslated
Blockly.Msg["OPTION_SOME_TOOLTIP"] = "constructor that represents that there is a value.";  // untranslated
Blockly.Msg["ORDINAL_NUMBER_SUFFIX"] = "";  // untranslated
Blockly.Msg["ORMAP_TOOLTIP"] = "Check if there exists an element that satisfies the predicate.";  // untranslated
Blockly.Msg["PAIR_GET_FIRST_TOOLTIP"] = "Get the first element of a pair";  // untranslated
Blockly.Msg["PAIR_GET_SECOND_TOOLTIP"] = "Get the second element of a pair";  // untranslated
Blockly.Msg["PLACE_IMAGES_TOOLTIP"] = "Place images at the specified coordinates on the scene.";  // untranslated
Blockly.Msg["PLACE_IMAGE_TOOLTIP"] = "Place an image at the specified coordinates on the scene.";  // untranslated
Blockly.Msg["POLYGON_OUTLINE_TOOLTIP"] = "Make a polygonal outline.";  // untranslated
Blockly.Msg["POLYGON_TOOLTIP"] = "Make a polygon.";  // untranslated
...
Blockly.Msg["RANDOM_FLOAT_TOOLTIP"] = "Generate a random float number between 0. and less than the first argument.";  // untranslated
Blockly.Msg["RANDOM_INT_TOOLTIP"] = "Generate a random integer between 0 and one less than the first argument.";  // untranslated
Blockly.Msg["READ_IMAGE_TOOLTIP"] = "Read an image of the given size";  // untranslated
Blockly.Msg["RECTANGLE_OUTLINE_TOOLTIP"] = "Make a rectangle outline.";  // untranslated
Blockly.Msg["RECTANGLE_TOOLTIP"] = "Make a rectangle.";  // untranslated
Blockly.Msg["REDO"] = "ಕುಡ ಮಲ್ಪು";
Blockly.Msg["REMOVE_COMMENT"] = "ಟಿಪ್ಪಣಿನ್ ದೆತ್ತ್‌ದ್ ಬುಡ್ಲೆ";
Blockly.Msg["REMOVE_IN"] = "Remove in";  // untranslated
Blockly.Msg["REMOVE_REC"] = "Remove rec";  // untranslated
...
Blockly.Msg["STRING_CONCAT"] = "Combine strings.";  // untranslated
Blockly.Msg["STRING_OF_BOOL"] = "Convert bool to string";  // untranslated
Blockly.Msg["STRING_OF_INT"] = "Convert an integer to a string.";  // untranslated
Blockly.Msg["SUM_TOOLTIP"] = "Return the sum of integers in the given list";  // untranslated
...
Blockly.Msg["TEXT_TOOLTIP"] = "Create a colored string.";  // untranslated
