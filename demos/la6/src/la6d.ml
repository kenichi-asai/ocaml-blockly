...
let draw {usagi = usagi_v; kame = kame_v} =
  ...
  else usagi_right) usagi_v (place_image (text "(490, 280)" 25 Color.black) (490, 280) (place_image (text "(210, 350)" 25 Color.black) (210, 350) (place_image goalzone (350, 525) (place_image back (280, 280) (empty_scene width height))))))
let move_u = 30
let move_k = 10
let move (x, y) v =
...
let move_break (ux, uy) (kx, ky) move_u =
  if uy < ? || ky > ? then move (ux, uy) move_u
  else (490, 280)
