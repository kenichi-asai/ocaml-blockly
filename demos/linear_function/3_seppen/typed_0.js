...
Typed.loadCode2 = function() {
    const code = "let f x = "+a+" * x + 0\n";
      if (code) {
        openModal();
        setTimeout(function() {
      BlockOfOCamlUtils.codeToBlock("type world_t = {\n  cat : int * int;\n  y : int;\n  down : bool;\n}\n"+beforecode + code + after);
            closeModal();
	    Blockly.mainWorkspace.getBlocksByType("defined_recordtype_typed", true)[0].setCollapsed(true);
	    Blockly.mainWorkspace.getBlocksByType("big_bang_typed", true)[0].setCollapsed(true);
	    var letblock1 = Blockly.mainWorkspace.getBlocksByType("let_fun_pattern_typed", true);
	    var letblock2 = Blockly.mainWorkspace.getBlocksByType("letstatement_fun_pattern_typed", true);
	    var letblock = letblock1.concat(letblock2);
	    var letblocks = letblock.filter(x=>x.getField("VAR").getText() != "f");
...
var a = 2;
var b = 5;
var beforecode = "let a = 2\nlet b = 5\n";

Typed.selectProgram = function(a, b) {
    var beforecode = "let a = "+a+"\nlet b = "+b+"\n";
}
