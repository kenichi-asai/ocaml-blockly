...
Tutorial.f4 = function() {
	...
	Tutorial.intro.addSteps([{element: field.fieldGroup_, intro: '値を'+a.value[0]+'に変更'}]).onchange(function(e){if(e!=field.fieldGroup_){dark();}else{clear_rect();draw_rect(field.fieldGroup_);}}).start();
	Blockly.mainWorkspace.addChangeListener(f = function(e){
