  ...
  */
  ...
  function _showElement(targetElement) {
    ...
    if (typeof this._introAfterChangeCallback !== "undefined") {
      ...
      const oldParentNode1 = introjsOverlay.parentNode;
      const oldParentNode2 = introjsHelperLayer.parentNode;
      const newParentNode = targetElement.element.parentNode;
      oldParentNode1.removeChild(introjsOverlay);
      oldParentNode2.removeChild(introjsHelperLayer);
      
      const introjsHelperLayer2 = document.querySelector('.introjs-helperLayer');
      if (introjsHelperLayer2 != null) {
      const oldParentNode3 = introjsHelperLayer2.parentNode;
      oldParentNode3.removeChild(introjsHelperLayer2);
      }
      
      newParentNode.appendChild(introjsOverlay);
      newParentNode.appendChild(introjsHelperLayer);
  }
