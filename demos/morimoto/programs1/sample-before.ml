...
let draw {airplane = (airplane_x, airplane_y); sun = (sun_x, sun_y); lop = lop} =
  place_image2 airplane (airplane_x, airplane_y) (place_image2 sun (sun_x mod width, sun_y mod height) (place_images2 (List.map make_contrails lop) lop (place_image2 (rectangle 10 10 Color.red) (1000, 500) (place_image2 (text "GOAL" 15 Color.red) (1000, 515) (place_image2 (text "(1000, 500)" 10 Color.red) (1000, 530) (zahyou_hyouji {airplane = (airplane_x, airplane_y); sun = (sun_x, sun_y); lop = lop}))))));;
