...
(*  卒業研究 stage3-2 飛行機をゴールへ向けて飛ばせてみよう *)
(*  世界の構造体の定義 *)
type world_t = {
...
let draw {airplane_zahyou = airplane_zahyou; sun_zahyou = (sun_x, sun_y); lop = lop; airplane_houkou = airplane_houkou} =
  place_image2 airplane airplane_zahyou (place_image2 sun (sun_x mod width, sun_y mod height) (place_images2 (List.map make_contrails lop) lop (place_image2 (rectangle 10 10 Color.red) (1000, 250) (place_image2 (text "GOAL" 15 Color.red) (1000, 265) (place_image2 (text "(1000, 250)" 10 Color.red) (1000, 280) (zahyou_hyouji {airplane_zahyou = airplane_zahyou; sun_zahyou = (sun_x, sun_y); lop = lop; airplane_houkou = airplane_houkou}))))));;
