...
let draw {airplane_zahyou = airplane_zahyou; sun_zahyou = (sun_x, sun_y); lop = lop; airplane_houkou = airplane_houkou} =
  place_image2 airplane airplane_zahyou (place_image2 sun (sun_x mod width, sun_y mod height) (place_images2 (List.map make_contrails lop) lop (place_image2 (rectangle 10 10 Color.red) (500, 250) (place_image2 (text "GOAL" 15 Color.red) (500, 265) (place_image2 (text "(500, 250)" 10 Color.red) (500, 280) (zahyou_hyouji {airplane_zahyou = airplane_zahyou; sun_zahyou = (sun_x, sun_y); lop = lop; airplane_houkou = airplane_houkou}))))));;
