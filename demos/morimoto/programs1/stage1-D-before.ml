...
let draw {airplane_zahyou = airplane_zahyou; sun_zahyou = (sun_x, sun_y); lop = lop; airplane_houkou = airplane_houkou} =
  place_image2 airplane airplane_zahyou (place_image2 sun (sun_x mod width, sun_y mod height) (place_images2 (List.map make_contrails lop) lop (place_image2 (circle 5 Color.red) (200, 100) (place_image2 (circle 5 Color.red) (400, 400) (place_image2 (circle 5 Color.red) (700, 500) (place_image2 (circle 5 Color.red) (1000, 300) (place_image2 (text "A" 12 Color.red) (190, 110) (place_image2 (text "B" 12 Color.red) (390, 410) (place_image2 (text "C" 12 Color.red) (690, 510) (place_image2 (text "D" 12 Color.red) (990, 310) (zahyou_hyouji {airplane_zahyou = airplane_zahyou; sun_zahyou = (sun_x, sun_y); lop = lop; airplane_houkou = airplane_houkou})))))))))));;
