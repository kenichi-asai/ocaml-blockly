#!/usr/bin/python2.7
# Update the demo page in docs4/ directory.
...
sourceMap = {
  ...
  "en.js": "msg/js/",
  "ja.js": "msg/js/",
  "index.html": "demos/class2020/dev.html",
  "style.css": "demos/class2020/",
...
def copy_files():
  for filename, src in sourceMap.items():
    shutil.copy(src, 'docs4/' + filename)

def edit_copied_files():
  disable_devmode()
  # TODO(harukam): Edit dev.html to load compressed JS files in docs4/ instead
