...
Blockly.BlockSvg.prototype.getIcons = function() {
  ...
  if (Array.isArray(this.workbenches)) {
...
Blockly.BlockSvg.prototype.moveToDragSurface = function() {
  ...
  if (this.isTransferable()) {
    ...
    if (!Blockly.utils.is3dSupported() || !mainSurface) {
      throw Error('The main workspace must have a dragSurface.');
    }
...
Blockly.BlockSvg.prototype.setInvalidStyle = function(enable) {
  ...
  if (enable) {
    hexColour = Blockly.utils.colour.blend('white', hexColour, 0.6);
    Blockly.utils.dom.addClass(this.svgGroup_, 'invalid');
  } else {
