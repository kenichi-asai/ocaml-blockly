...
Blockly.Bubble.prototype.createDom_ = function(content, hasResize) {
  ...
  */
  ...
  var filter =
      {'filter': 'url(#' +
      this.mainWorkspace_.getRenderer().getConstants().embossFilterId + ')'};
  ...
  if (this.childBubbleCanvas_) {
    ...
    this.childBubbleCanvas_ = Blockly.utils.dom.createSvgElement('g',
...
Blockly.Bubble.prototype.layoutBubble_ = function() {
  ...
  metrics.viewTop /= this.mainWorkspace_.scale;
  metrics.viewHeight /= this.mainWorkspace_.scale;
