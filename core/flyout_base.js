 ...
 * @param {!Array|!NodeList|string|!Function} xmlList List of blocks
 *     to show, or function to return blocks to show.
...
Blockly.Flyout.prototype.obtainContentsToShow_ = function(xmlList, gaps) {
  ...
  if (typeof xmlList == 'string') {
    ...
    if (!Array.isArray(xmlList)) {
      throw TypeError('The result of a toolbox category callback must be ' +
          'an array.');
    }
  } else if (typeof xmlList == 'function') {
