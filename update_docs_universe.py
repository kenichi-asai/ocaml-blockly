#!/usr/bin/python2.7
# Update the demo page in docs2/ directory.
...
sourceMap = {
  ...
  "en.js": "msg/js/",
  "ja.js": "msg/js/",
  "index.html": "demos/universe/dev.html",
  "style.css": "demos/universe/",
  "typed.js": "demos/universe/",
  "eval.js": "demos/universe/",
  "canvas.html": "demos/universe/",
}
...
def copy_files():
  for filename, src in sourceMap.items():
    shutil.copy(src, 'docs2/' + filename)

def edit_copied_files():
  disable_devmode()
  # TODO(harukam): Edit dev.html to load compressed JS files in docs2/ instead
